...
validate_replica_artifacts() {
  ...
  awk -F '\t' -v run="$RUN_KEY" 'NR > 1 {
    if (NF != 6 || $1 != run || $2 !~ /^[1-9][0-9]*$/ || $3 !~ /^[0-9]+$/ ||
        ...
        $6 !~ /^[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]T[0-9][0-9]:[0-9][0-9]:[0-9][0-9][.][0-9][0-9][0-9][0-9][0-9][0-9]Z$/) exit 1
  }' "$lag" &&
  awk -F '\t' 'NR > 1 {
    if (NF != 6 || $1 !~ /^[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]T[0-9][0-9]:[0-9][0-9]:[0-9][0-9][.][0-9][0-9][0-9][0-9][0-9][0-9]Z$/ ||
  ...
  awk -F '\t' -v mode="$REPLICA_EXPERIMENT" 'NR > 1 {
    if (NF != 5 || $1 != mode || ($2 != "sql_thread" && $2 != "container" && $2 != "source_final") ||
        $3 !~ /^[1-9][0-9]*$/ ||
        $4 !~ /^[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]T[0-9][0-9]:[0-9][0-9]:[0-9][0-9][.][0-9][0-9][0-9][0-9][0-9][0-9]Z$/ ||
        $5 !~ /^[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]T[0-9][0-9]:[0-9][0-9]:[0-9][0-9][.][0-9][0-9][0-9][0-9][0-9][0-9]Z$/ || $5 < $4) exit 1
  }' "$faults" &&
  awk -F '\t' 'NR > 1 {
