...
class StockServiceTest {
    ...
    void reserveLoadsAllSkusInOneBatch() {
        ...
        when(skuRepository.findAllByIdIn(List.of(11L, 12L))).thenReturn(List.of(sku1, sku2));
        ...
        when(stockRepository.tryReserve(11L, 1)).thenReturn(1);
        when(stockRepository.tryReserve(12L, 2)).thenReturn(1);
        ...
        verify(skuRepository).findAllByIdIn(List.of(11L, 12L));
